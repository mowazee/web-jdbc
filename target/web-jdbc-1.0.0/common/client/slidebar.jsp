        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="5000">
                <div class="carousel-img-container">
                    <img src="<c:url value='/common/image/hero1.jpg'/>" class="d-block w-100" alt="Gạo đặc sản" loading="lazy" decoding="async" width="1400" height="600">
                </div>
            ...
            <div class="carousel-item" data-bs-interval="5000">
                <div class="carousel-img-container">
                    <img src="<c:url value='/common/image/hero2.jpg'/>" class="d-block w-100" alt="Gạo quê hương" loading="lazy" decoding="async" width="1400" height="600">
                </div>
                <div class="carousel-caption d-none d-md-block animated-caption">
            ...
            <div class="carousel-item" data-bs-interval="5000">
                <div class="carousel-img-container">
                    <img src="<c:url value='/common/image/hero3.jpg'/>" class="d-block w-100" alt="Combo quà tặng" loading="lazy" decoding="async" width="1400" height="600">
                </div>
                <div class="carousel-caption d-none d-md-block animated-caption">
